...
const NavBar = () => {
    return (
        <nav className={classNames("border-b-8 border-solid border-blue-300 flex flex-col 2xl:flex-row justify-between mx-auto p-10 px-14 lg:px-28", styles.navBorder)}>
