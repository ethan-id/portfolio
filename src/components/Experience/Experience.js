                ...
                <ul role="list" className="divide-y divide-gray-100">
                    <li className="flex justify-between gap-x-6 py-5">
                        <div className="flex gap-x-4">
                            <img className="h-10 lg:h-12 w-10 lg:w-12 flex-none rounded-full bg-gray-50 m-auto" src="https://media.licdn.com/dms/image/D4E0BAQGHcvebsMflbA/company-logo_100_100/0/1684271619207?e=1695859200&v=beta&t=VhjlBcWQSzUC0CxmGoJ-eVnlkeXOy_iriCbl7NbBNBI" alt="Deere & Co. Logo"/>
                            <div className="min-w-0 flex-auto m-auto">
                                <p className="text-lg lg:text-2xl font-semibold">John Deere</p>
                            </div>
                        </div>
                        <div className="align-center">
                            <p className="text-md lg:text-2xl font-semibold">Part Time Student Software Engineer</p>
                            <p className="flex mt-1 text-sm lg:text-lg justify-end">May 2021 - Present</p>
                        </div>
                    </li>
                    <li className="flex justify-between gap-x-6 py-5">
                        <div className="flex gap-x-4">
                            <img className="h-10 lg:h-12 w-10 lg:w-12 flex-none rounded-full bg-gray-50 m-auto" src="https://media.licdn.com/dms/image/C560BAQF5eFV54Ah03Q/company-logo_100_100/0/1670603375387?e=1695859200&v=beta&t=2qiWzuJ5q6rgNeWTSxlKZVjJ7iNaZZ7Waaf0twd08JQ" alt="ProMax Logo"/>
                            <div className="min-w-0 align-center m-auto">
                                <p className="text-lg lg:text-2xl font-semibold">ProMax</p>
                            </div>
                        </div>
                        <div className="align-center">
                            <p className="text-md lg:text-2xl font-semibold">Software Engineering Intern</p>
                            <p className="flex mt-1 text-sm lg:text-lg justify-end">Jan 2020 - Apr 2020</p>
                        </div>
                    </li>
                </ul>
            </div>
                ...
                <div className='flex flex-row'>
                    <ul role="list" className="divide-y divide-gray-100 mx-auto w-72">
                        <li className="flex flex-col justify-between gap-x-6 py-5">
                            <div className="flex flex-row m-auto gap-x-4">
                                ...
                                <div className="min-w-0 flex-auto m-auto">
                                    <p className="text-sm lg:text-2xl font-semibold">TypeScript</p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li className="flex flex-col justify-between gap-x-6 py-5">
                            <div className="flex flex-row m-auto gap-x-4">
                                ...
                                <div className="min-w-0 flex-auto m-auto">
                                    <p className="text-sm lg:text-2xl font-semibold">React</p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li className="flex justify-between gap-x-6 py-5">
                            <div className="flex flex-row m-auto gap-x-4">
                                ...
                                <div className="min-w-0 flex-auto m-auto">
                                    <p className="text-sm lg:text-2xl font-semibold">Redux</p>
                                </div>
                            </div>
                        </li>
                    </ul>
                    ...
                    <ul role="list" className="divide-y divide-gray-100 mx-auto w-72 flex flex-col align-center">
                        <li className="flex flex-col gap-x-6 py-5">
                            <div className="flex flex-row m-auto gap-x-4">
                                ...
                                <div className="min-w-0 flex-auto m-auto">
                                    <p className="text-sm lg:text-2xl font-semibold">Sass</p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li className="flex justify-between gap-x-6 py-5">
                            <div className="flex flex-row m-auto gap-x-4">
                                ...
                                <div className="min-w-0 flex-auto m-auto">
                                    <p className="text-sm lg:text-2xl font-semibold">Tailwind</p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li className="flex flex-col justify-between gap-x-6 py-5">
                            <div className="flex flex-row m-auto gap-x-4">
                                ...
                                <div className="min-w-0 flex-auto m-auto">
                                    <p className="text-sm lg:text-2xl font-semibold">Bootstrap</p>
                                </div>
                            </div>
                        </li>
                    </ul>
                    ...
                    <ul role="list" className="divide-y divide-gray-100 mx-auto w-72">
                        <li className="flex flex-col justify-between gap-x-6 py-5">
                            <div className="flex flex-row m-auto gap-x-4">
                                ...
                                <div className="min-w-0 flex-auto m-auto">
                                    <p className="text-sm lg:text-2xl font-semibold">NextJS</p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li className="flex justify-between gap-x-6 py-5">
                            <div className="flex flex-row m-auto gap-x-4">
                                ...
                                <div className="min-w-0 flex-auto m-auto">
                                    <p className="text-sm lg:text-2xl font-semibold">MongoDB</p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li className="flex flex-col justify-between gap-x-6 py-5">
                            <div className="flex flex-row m-auto gap-x-4">
                                ...
                                <div className="min-w-0 flex-auto m-auto">
                                    <p className="text-sm lg:text-2xl font-semibold">NodeJS</p>
                                </div>
                            </div>
                        </li>
                    </ul>
