export const Education = () => {
    return (
        <div className='mt-5'>
            <div className='flex justify-left text-2xl lg:text-3xl font-semibold lg:mb-5'>Education</div>
            <ul
                role='list'
                ...
                <li className='flex justify-between gap-x-6 py-5'>
                    <div className='flex gap-x-4'>
                        ...
                        <div className='min-w-0 flex-auto m-auto'>
                            <p className='text-lg lg:text-xl font-semibold'>Iowa State University</p>
                        </div>
                    </div>
                    <div className='align-center'>
                        <p className='text-xs lg:text-xl text-right font-semibold'>B.S. Software Engineering</p>
